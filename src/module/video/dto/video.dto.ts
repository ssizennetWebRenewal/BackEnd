...
export class VideoDto {
  ...
  @ApiProperty({ description: '영상 제목', example: '[#별별메이트] 홈술 할 때 보면 1시간 순삭🍺 위에 기름칠 하고 쏘맥 싸악 말면 그곳이 바로 천국이쥬? | #스트리트푸드파이터 #디글' })
  @IsString()
  title: string = "";
...
export class VideoResponseDto extends VideoDto {
  @ApiProperty({ description: '영상 ID', example: 'f7b3b1b0-1b7d-4b3b-8b3b-1b7d4b3b8b3b' })
  @IsString()
  id: string = "";
